...
/**
 * Representa un jugador asociado a un equipo con su mano sus puntos actuales y
 * acumulados.
 */
public class Jugador {
	...
	/**
	 * True si ya se contabilizo la bonificacion por jugar todas las cartas de
	 * seguridad.
	 */
	...
	/**
	 * Establece la pila actual. Permite compartir una pila entre varios jugadores.
	 * 
	 * @param pila
	 */
	...
	/**
	 * @param jugador
	 * @return True si el jugador recibido es del mismo equipo que el jugador
	 *         actual.
	 */
	...
	/**
	 * Transfiere una cantidad de cartas desde el mazo a la mano del jugador.
	 * 
	 * @param mazo
	 * @param cantidad
	 * @return
	...
	/**
	 * Establece en false la bandera que indica que el jugador contabilizó todas las
	 * cartas de seguridad.
	 */
	...
	/**
	 * Establece en true la bandera que indica que el jugador contabilizó todas las
	 * cartas de seguridad.
	 */
	...
	/**
	 * Bandera para evitar contabilizar más de una vez que el jugador contabilizó
	 * todas las cartas de seguridad.
	 * 
