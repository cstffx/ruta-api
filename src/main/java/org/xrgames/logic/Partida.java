...
public class Partida {
	...
	/**
	 * Contabiliza los puntos al final de la partida. Aumenta los puntos acumulados
	 * de cada jugador con los puntos de la partida y los puntos ganados por
	 * bonificaciones al final de la partida.
	 */
	...
	/**
	 * Inicia una nueva partida En una nueva partida se reinicia el mazo, así como
	 * las manos, las pilas y los puntos parciales de los jugadores.
	 */
	...
	/**
	 * Roba una carta del mazo para el jugador actual. En algunos casos es necesario
	 * cambiar el jugador actual, por ejemplo en un contrataque, utilice
	 * setJugadorActual para establecer el jugador el contrataque.
	 * 
	 * @return
	 */
	...
	/**
	 * En juegos por equipo calcula la puntuacion total de un equipo como la suma de
	 * los puntos de los jugadores de cada equipo. El resultado es una lista donde
	 * el indice indica el numero del equipo en base 0. Es decir, al equipo 1 le
	 * corresponde el indice 0.
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @return -1 si no hay equipo ganador, de lo contrario el numero del equipo en
	 *         base 1.
	 */
